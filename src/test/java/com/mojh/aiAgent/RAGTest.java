...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("C:\\Users\\MI\\Desktop\\mojh\\learn\\XzAgent\\src\\main\\resources\\ragFile\\测试.txt");
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument("C:\\Users\\MI\\Desktop\\mojh\\learn\\XzAgent\\src\\main\\resources\\ragFile\\医院信息.pdf", new ApacheTikaDocumentParser());
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("C:\\Users\\MI\\Desktop\\mojh\\learn\\XzAgent\\src\\main\\resources\\ragFile\\人工智能.md");
    ...
    public void testTokenCount() {
        ...
        ChatMessage userMessage = new UserMessage("user", text);
        //计算 token 长度
        //QwenTokenizer tokenizer = new QwenTokenizer(System.getenv("DASH_SCOPE_API_KEY"),"qwen-max");
        TokenCountEstimator openAiTokenCountEstimator = new OpenAiTokenCountEstimator("gpt-4");
        int count = openAiTokenCountEstimator.estimateTokenCountInMessage(userMessage);
